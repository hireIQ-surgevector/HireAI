...
//   /*
//    * Only candidates who can move to another interview
//    * should be displayed.
//    *
//    * Candidates who are already at a terminal stage
//    * are removed from the selection list.
//    */
...
//       return stage && !excludedStages.includes(stage);
//     });
//   }, [candidates]);
...
//   /*
//    * Determine the next interview round automatically.
//    *
...
//     const stage = String(selectedCandidate.current_stage || "")
//       .trim()
//       .toLowerCase();

//     switch (stage) {
//       case "technical screening cleared":
//         return "L1 – Initial Technical";

//       case "l1 cleared":
//         return "L2 – Advanced Technical";

//       case "l2 cleared":
//         return "L3 – Managerial";

//       case "managerial cleared":
//         return "HR – Final Discussion";
...
//   /*
//    * Clear scheduling information when candidate changes.
//    */
...
//    *
//    * The actual POST endpoint needs to be connected here
//    * once the backend scheduling endpoint is available.
//    */
...
//       alert("This candidate is not eligible for another interview round.");
//       return;
//     }
...
//       /*
//        * This is the data that should be sent to the backend.
//        *
//        * Once your scheduling API endpoint is available,
...
//                 <span>
//                   Current Stage:{" "}
//                   <strong>{selectedCandidate.current_stage}</strong>
//                 </span>
//               </div>
...
//                 }}
//               >
//                 <h3 style={{ marginBottom: "4px" }}>Interview Details</h3>
...
//                 }}
//               >
//                 <h3 style={{ marginBottom: "4px" }}>Schedule</h3>
...
function ScheduleInterviewPage() {
  ...
  const handleSchedule = async () => {
    ...
    if (!nextInterviewRound) {
      alert(
        "There is no next interview round available for this candidate."
      );
      return;
    }
    ...
    try {
      ...
      /*
       * Add your interview scheduling API call here.
       */
        ...
        <div className="card">
          ...
          <div className="section-header">
            <div>
              ...
              <p className="muted">
                Select a candidate and schedule their next
                interview round.
              </p>
            </div>
          </div>
            ...
            eligibleCandidates.length === 0 && (
              <div className="candidate-empty-state">
                ...
                <p>
                  ...
                  eligible for another interview round.
                </p>
              </div>
            )}
          ...
          {selectedCandidate && (
            <>
              ...
              >
                ...
                <p className="muted">
                  Select the date and time for the
                  interview.
                </p>
              </div>
              ...
              <div className="info-box">
                ...
                A calendar invitation will be
                automatically sent to the candidate
