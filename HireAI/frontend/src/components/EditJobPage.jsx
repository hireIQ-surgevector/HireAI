...
//         {error && (
//           <div className="error-box" style={{ marginBottom: '16px', color: 'red' }}>
//             {error}
//           </div>
//         )}

//         {success && (
//           <div className="success-box" style={{ marginBottom: '16px', color: 'green' }}>
//             {success}
//           </div>
//         )}
...
//             Update requirements, location, or job specifications.
//           </p>
...
//           <div
//             className="form-row"
//             style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', marginBottom: '24px' }}
//           >
//             <div>
//               <label style={{ display: 'block', fontWeight: 'bold', marginBottom: '6px' }}>
...
//                 <option value="Live Technical Interview">Live Technical Interview</option>
