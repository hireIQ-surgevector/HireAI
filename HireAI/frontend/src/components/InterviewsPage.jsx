    ...
    >
      <div className="interviews-page">
        ...
        <div className="interviews-header">
          <div>
            <p className="interviews-eyebrow">INTERVIEW MANAGEMENT</p>
        ...
        <div className="interviews-table-card">
          {loading ? (
            ...
            <div className="interviews-empty-state">
              ...
              {canManageCandidates(session) && (
                <Link to="/schedule-interview" className="btn btn-primary">
                  <Plus size={16} />
                  Schedule Interview
                </Link>
              )}
              ...
              <table className="interviews-table">
                <thead>
                  <tr>
                    ...
                    <th>Schedule</th>
                    <th>Round</th>
                    <th className="interviews-actions-heading">Actions</th>
                  </tr>
                </thead>
